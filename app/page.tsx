...
// Simple types for the minimal version
interface Product {
  id: string
  name: string
  description: string
...
export default function Home() {
  ...
  const selectedUserStory = selectedEpic?.userStories.find((us) => us.id === selectedUserStoryId)
  ...
  if (currentView === "kanban") {
    ...
    const columns = [
      { id: "todo", title: "To Do", tasks: allTasks.filter((t) => t.status === "todo") },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage your sprint tasks</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-2">View all items in a tree structure</p>
            </div>
            <Button variant="outline" onClick={() => setCurrentView("backlog")}>
              Back to Backlog
            </Button>
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
          ...
          {selectedEpic && (
            <>
              ...
              <Button
                ...
                className={!selectedUserStoryId ? "bg-blue-100" : ""}
              >
        ...
        <div className="grid gap-6">
          ...
          {/* User Stories View */}
          {selectedEpic && !selectedUserStoryId && (
            <div>
              <div className="flex justify-between items-center mb-4">
                  ...
                  .map((story) => (
                    ...
                    >
                      ...
                      <CardContent>
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <div className="text-sm text-gray-500">{story.tasks.length} tasks</div>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
